...
class _FuckTheNeighborGameState extends State<FuckTheNeighborGame> {
  ...
  String _t(String key) {
    const Map<String, Map<String, String>> dictionary = {
      ...
      'ar': { 'title': 'Fuck the Neighbor', 'add_hint': 'الاسم', 'add_err': 'الحد الأقصى 12 لاعبًا!', 'add_err_min': 'الحد الأدنى 3 لاعبين!', 'start': 'بدء', 'rules': 'قواعد', 'ok': 'فهمت', 'round': 'R', 'score_board': 'لوحة النتائج', 'winner': 'الفائز', 'penalty': 'نقاط الجزاء', 'rematch': 'إعادة', 'new_game': 'لعبة جديدة (الإعداد)', 'phase1': 'توقع', 'phase2': 'حيل', 'starts': 'يبدأ', 'bid_info': 'توقع', 'forbidden': 'ليس', 'called': 'تم التوقع', 'tricks_left': 'المتبقي للتوزيع: ', 'btn_p1': 'التالي', 'btn_p2': 'إنهاء', 'btn_err': 'يجب أن تتطابق الحيل', 'err_dealer': 'قاعدة الموزع: يجب ألا يتطابق المجموع!', 'deck_size': 'مجموعة الأوراق', 'deck_1': 'مجموعة واحدة (36)', 'deck_2': 'مجموعتان (72)', 'multiplier_opt': 'مضاعف متزايد', 'multiplier_desc': 'الجزاء × رقم الجولة (R1=×1, R3=×3, ...)', 'shuffles': 'يخلط ويوزع', 'deals_short': 'الموزع', 'lbl_players': 'اللاعبون', 'lbl_material': 'المواد', 'lbl_goal': 'الهدف', 'r_options': 'خيارات', 'r_options_txt': 'في الإعداد يمكنك اللعب بمجموعتين من الأوراق (72 ورقة) وتفعيل مضاعف متزايد يضاعف نقاط الجزاء برقم الجولة. يتم عرض من يخلط/يوزع في كل جولة.', 'r_overview': 'نظرة عامة', 'r_players': 'من 3 إلى 12 شخصًا', 'r_material': 'أوراق جاس (36 أو 72 مع مجموعتين)', 'r_goal': 'الوصول إلى 0 نقطة. (الفرق = الجزاء)', 'r_flow': 'سير اللعب', 'r_s1': 'توزيع الأوراق (R1 = الحد الأقصى، ثم -1).', 'r_s2': 'التوقعات.', 'r_s3': 'اللعب (أعلى ورقة تفوز بالحيلة).', 'r_s4': 'الحساب (|التوقع - الحيل|).', 'r_rules': 'القواعد', 'r_dealer': 'قاعدة الموزع', 'r_dealer_txt': 'مجموع التوقعات ≠ عدد الأوراق!', 'r_block': 'الحظر', 'r_block_txt': 'الأوراق الأعلى المتساوية تحظر بعضها البعض.', 'r_final': 'النهائي', 'r_final_txt': 'آخر ورقة على الجبهة (بشكل أعمى)!' },
    };
