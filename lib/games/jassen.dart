...
class _JassenGameState extends State<JassenGame> {
  ...
  String _t(String key) {
    const Map<String, Map<String, String>> dictionary = {
      ...
      'ar': {
        'title': 'جاس', 'rules': 'القواعد', 'ok': 'فهمت',
        'mode_schieber': 'شيبر', 'desc_schieber': 'فريق ضد فريق. 157 نقطة + إعلانات.',
        'mode_diff': 'ديفيرنزلر', 'desc_diff': 'توقع نتيجتك. الفرق يصبح عقوبة.',
        'team1': 'نحن', 'team2': 'هم', 'undo': 'تراجع', 'reset': 'لعبة جديدة',
        'input_score': 'النقاط...', 'round': 'جولة',
        'add_player': 'إضافة', 'start': 'بدء', 'prediction': 'إعلان',
        'score': 'النتيجة', 'penalty': 'عقوبة', 'weis_mode': 'مكافأة',
        'weis_on': 'وضع المكافأة: تشغيل', 'weis_off': 'وضع الأخذات',
        'rules_text': 'اختر وضعك:\n\n• شيبر: أدخل نقاط أحد الفريقين، ويذهب الباقي (من 157) تلقائيًا إلى الفريق الآخر. اختر اختياريًا مضاعفًا (×1-×4) للورقة الرابحة قبل إدخال النقاط. بالنسبة للمكافأة (Weis): فعّل زر النجمة - تُضاف النقاط حينها مباشرة وبدون مضاعف. يضيف زر Stöck 20 نقطة مباشرة لأحد الفريقين. يمكنك اختياريًا تحديد نتيجة مستهدفة (اضغط على عرض الهدف) - عند الوصول إليها تنتهي المباراة. يعرض زر السجل جميع الإدخالات السابقة.\n\n• ديفيرنزلر: أضف لاعبين واختياريًا حد أقصى للجولات. في كل جولة يعلن كل لاعب نتيجته، ثم يدخل النتيجة الفعلية - يصبح الفرق نقاط عقوبة. يُعرض رقم الجولة الحالية أعلى الشاشة؛ يمكن الوصول لسجل الجولات عبر ذلك الشريط. مع وجود حد للجولات، تنتهي اللعبة تلقائيًا ويفوز من لديه أقل نقاط عقوبة.',
        'add_hint': 'الاسم', 'rename_title': 'تغيير الاسم', 'cancel': 'إلغاء', 'save': 'حفظ',
        'multiplier': 'المضاعف', 'stoeck': 'Stöck', 'target': 'الهدف', 'no_target': 'بدون هدف',
        'history': 'السجل', 'no_history': 'لا توجد إدخالات بعد', 'match_won': 'يفوز بالمباراة!',
        'round_limit': 'حد الجولات', 'no_limit': 'غير محدود', 'rounds_short': 'جولات',
        'game_over': 'انتهت اللعبة', 'winner': 'الفائز', 'new_game_btn': 'لعبة جديدة',
        'type_trick': 'أخذة', 'type_weis': 'Weis', 'type_stoeck': 'Stöck',
      },
    };
