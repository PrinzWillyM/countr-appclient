...
class _PokemonTCGGameState extends State<PokemonTCGGame> {
  ...
  String _t(String key) {
    const Map<String, Map<String, String>> dictionary = {
      ...
      'ar': { 'title': 'بوكيمون TCG', 'rules': 'قواعد', 'ok': 'فهمت', 'you': 'أنت', 'opponent': 'الخصم', 'prizes': 'جوائز', 'active': 'نشط', 'bench': 'احتياط', 'clear': 'مسح', 'swap_active': 'تبديل', 'manage_prizes': 'جوائز', 'back': 'رجوع', 'rename_title': 'تغيير الاسم', 'cancel': 'إلغاء', 'save': 'حفظ', 'supporter': 'داعم', 'retreat': 'انسحاب', 'end_turn': 'إنهاء الدور', 'turn': 'الدور', 'rules_text': 'الرفيق المثالي لبطاقات TCG:\n\n• السحب والإفلات: اسحب رموز الضرر أو الحالة من المنتصف إلى بوكيمون.\n• التعديل: اضغط على بوكيمون لتعديل العدادات.\n• التبديل: اضغط على بوكيمون في الاحتياط لتبديله مع النشط.\n• مرة واحدة لكل مباراة: اضغط على [GX] / [VSTAR] لتحديدها كمستخدمة.\n• إجراءات الدور: تتبع الداعمين الذين تم لعبهم والانسحابات المستخدمة.' },
    };
